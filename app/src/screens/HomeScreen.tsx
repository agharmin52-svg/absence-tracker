...
import { MonthlyProgressSection } from '../components/sections/MonthlyProgressSection';
import { EmotionalStatisticsSection } from '../components/sections/EmotionalStatisticsSection';
import { LastMemoryCard } from '../components/sections/LastMemoryCard';
  ...
  return (
    <ScreenContainer style={styles.screen}>
      ...
      <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
        ...
        {/* آخرین یادآوری */}
        <LastMemoryCard entry={memoryStats?.lastEntry} />

        {/* پیشرفت ماهانه */}
        <MonthlyProgressSection entries={entries} />

        {/* تحلیل احساسی */}
        <EmotionalStatisticsSection moodStats={moodStats} />
